...
## Black and White: game-specific rules

### Rules updates for Standard & up

1) Avoid accepting and turning-on C-GEAR at risk of soft locking your game.
2) You are allowed to change to game's time for events that occur on specific days within the game. However, you cannot change the game's time clock until **after** the first two battles.
3) The Randomizer setting for Wild Pokemon "Area 1-1 Mapping" has been changed to "Random", allowing for additional pivot options

### Rules for Ultimate & up

1) All trainers in Wellspring Cave must be defeated before leaving. You may re-enter later upon receiving Surf.
