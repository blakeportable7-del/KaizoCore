# FireRed and LeafGreen: Kaizo Doubles
...
Kaizo doubles is a fun variant of Kaizo Ironmon where every battle is a doubles battle (2v2). These rules are still a work in progress, so check back often for updates.
