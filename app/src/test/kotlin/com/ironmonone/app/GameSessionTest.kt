...
class GameSessionTest {
    ...
    fun `tracked only on a CRC match, never on a header`() {
        ...
        assertEquals(RomKind.CRC_UNKNOWN, RomKind.BLACK_U.expectedCrc)   // every other DS kind was pinned from a dump on 2026-09-06; Black waits for one
        assertNull(GameSession.trackerKind(RomKind.BLACK_U, 0x12345678L))
