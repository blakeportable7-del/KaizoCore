...
public class LibretroDroid {
    ...
    public static native void setSlowMotion(int divisor);
    // KaizoCore patch: RetroAchievements (rcheevos rc_client in native code).
    public static native void cheevosLogin(String user, String secret, boolean isToken);
    public static native void cheevosLogout();
    public static native void cheevosSetHardcore(boolean on);
    public static native void cheevosLoadGame(String path, int consoleId);
    public static native void cheevosUnloadGame();
    public static native void cheevosReset();
    public static native void cheevosIdle();
    public static native void cheevosServerResponse(int id, String body, int status);
    public static native String cheevosSummary();
    public static native String cheevosAchievements();
    ...
    /**
     * IronMON One patch: read emulated memory via captured SET_MEMORY_MAPS descriptors.
     * Returns an empty array when the range is unmapped - never zero-filled data.
     */
    public static native byte[] readMemory(long address, int length);
