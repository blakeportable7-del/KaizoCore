...
public class Moves {
    ...
    public static final int shoreUp = 622;
    public static final int firstImpression = 623;
    public static final int banefulBunker = 624;
    public static final int spiritShackle = 625;
    public static final int darkestLariat = 626;
    public static final int sparklingAria = 627;
    public static final int iceHammer = 628;
    public static final int floralHealing = 629;
    public static final int highHorsepower = 630;
    public static final int strengthSap = 631;
    public static final int solarBlade = 632;
    public static final int leafage = 633;
    public static final int spotlight = 634;
    public static final int toxicThread = 635;
    public static final int laserFocus = 636;
    public static final int gearUp = 637;
    public static final int throatChop = 638;
    public static final int pollenPuff = 639;
    public static final int anchorShot = 640;
    public static final int psychicTerrain = 641;
    public static final int lunge = 642;
    public static final int fireLash = 643;
    public static final int powerTrip = 644;
    public static final int burnUp = 645;
    public static final int speedSwap = 646;
    public static final int smartStrike = 647;
    public static final int purify = 648;
    public static final int revelationDance = 649;
    public static final int coreEnforcer = 650;
    public static final int tropKick = 651;
    public static final int instruct = 652;
    public static final int beakBlast = 653;
    public static final int clangingScales = 654;
    public static final int dragonHammer = 655;
    public static final int brutalSwing = 656;
    public static final int auroraVeil = 657;
    public static final int shellTrap = 658;
    public static final int fleurCannon = 659;
    public static final int psychicFangs = 660;
    public static final int stompingTantrum = 661;
    public static final int shadowBone = 662;
    public static final int accelerock = 663;
    public static final int liquidation = 664;
    public static final int prismaticLaser = 665;
    public static final int spectralThief = 666;
    public static final int sunsteelStrike = 667;
    public static final int moongeistBeam = 668;
    public static final int tearfulLook = 669;
    public static final int zingZap = 670;
    public static final int naturesMadness = 671;
    public static final int multiAttack = 672;
    public static final int mindBlown = 673;
    public static final int plasmaFists = 674;
    public static final int photonGeyser = 675;
    public static final int zippyZap = 676;
    public static final int splishySplash = 677;
    public static final int floatyFall = 678;
    public static final int pikaPapow = 679;
    public static final int bouncyBubble = 680;
    public static final int buzzyBuzz = 681;
    public static final int sizzlySlide = 682;
    public static final int glitzyGlow = 683;
    public static final int baddyBad = 684;
    public static final int sappySeed = 685;
    public static final int freezyFrost = 686;
    public static final int sparklySwirl = 687;
    public static final int veeveeVolley = 688;
    public static final int doubleIronBash = 689;
    public static final int dynamaxCannon = 690;
    public static final int snipeShot = 691;
    public static final int jawLock = 692;
    public static final int stuffCheeks = 693;
    public static final int noRetreat = 694;
    public static final int tarShot = 695;
    public static final int magicPowder = 696;
    public static final int dragonDarts = 697;
    public static final int teatime = 698;
    public static final int octolock = 699;
    public static final int boltBeak = 700;
    public static final int fishiousRend = 701;
    public static final int courtChange = 702;
    public static final int clangorousSoul = 703;
    public static final int bodyPress = 704;
    public static final int decorate = 705;
    public static final int drumBeating = 706;
    public static final int snapTrap = 707;
    public static final int pyroBall = 708;
    public static final int behemothBlade = 709;
    public static final int behemothBash = 710;
    public static final int auraWheel = 711;
    public static final int breakingSwipe = 712;
    public static final int branchPoke = 713;
    public static final int overdrive = 714;
    public static final int appleAcid = 715;
    public static final int gravApple = 716;
    public static final int spiritBreak = 717;
    public static final int strangeSteam = 718;
    public static final int lifeDew = 719;
    public static final int obstruct = 720;
    public static final int falseSurrender = 721;
    public static final int meteorAssault = 722;
    public static final int eternabeam = 723;
    public static final int steelBeam = 724;
    public static final int expandingForce = 725;
    public static final int steelRoller = 726;
    public static final int scaleShot = 727;
    public static final int meteorBeam = 728;
    public static final int shellSideArm = 729;
    public static final int mistyExplosion = 730;
    public static final int grassyGlide = 731;
    public static final int risingVoltage = 732;
    public static final int terrainPulse = 733;
    public static final int skitterSmack = 734;
    public static final int burningJealousy = 735;
    public static final int lashOut = 736;
    public static final int poltergeist = 737;
    public static final int corrosiveGas = 738;
    public static final int coaching = 739;
    public static final int flipTurn = 740;
    public static final int tripleAxel = 741;
    public static final int dualWingbeat = 742;
    public static final int scorchingSands = 743;
    public static final int jungleHealing = 744;
    public static final int wickedBlow = 745;
    public static final int surgingStrikes = 746;
    public static final int thunderCage = 747;
    public static final int dragonEnergy = 748;
    public static final int freezingGlare = 749;
    public static final int fieryWrath = 750;
    public static final int thunderousKick = 751;
    public static final int glacialLance = 752;
    public static final int astralBarrage = 753;
    public static final int eerieSpell = 754;
    public static final int direClaw = 755;
    public static final int psyshieldBash = 756;
    public static final int powerShift = 757;
    public static final int stoneAxe = 758;
    public static final int springtideStorm = 759;
    public static final int mysticalPower = 760;
    public static final int ragingFury = 761;
    public static final int waveCrash = 762;
    public static final int chloroblast = 763;
    public static final int mountainGale = 764;
    public static final int victoryDance = 765;
    public static final int headlongRush = 766;
    public static final int barbBarrage = 767;
    public static final int esperWing = 768;
    public static final int bitterMalice = 769;
    public static final int shelter = 770;
    public static final int tripleArrows = 771;
    public static final int infernalParade = 772;
    public static final int ceaselessEdge = 773;
    public static final int bleakwindStorm = 774;
    public static final int wildboltStorm = 775;
    public static final int sandsearStorm = 776;
    public static final int lunarBlessing = 777;
    public static final int takeHeart = 778;
    public static final int teraBlast = 779;
    public static final int silkTrap = 780;
    public static final int axeKick = 781;
    public static final int lastRespects = 782;
    public static final int luminaCrash = 783;
    public static final int orderUp = 784;
    public static final int jetPunch = 785;
    public static final int spicyExtract = 786;
    public static final int spinOut = 787;
    public static final int populationBomb = 788;
    public static final int iceSpinner = 789;
    public static final int glaiveRush = 790;
    public static final int revivalBlessing = 791;
    public static final int saltCure = 792;
    public static final int tripleDive = 793;
    public static final int mortalSpin = 794;
    public static final int doodle = 795;
    public static final int filletAway = 796;
    public static final int kowtowCleave = 797;
    public static final int flowerTrick = 798;
    public static final int torchSong = 799;
    public static final int aquaStep = 800;
    public static final int ragingBull = 801;
    public static final int makeItRain = 802;
    public static final int ruination = 803;
    public static final int collisionCourse = 804;
    public static final int electroDrift = 805;
    public static final int shedTail = 806;
    public static final int chillyReception = 807;
    public static final int tidyUp = 808;
    public static final int snowscape = 809;
    public static final int pounce = 810;
    public static final int trailblaze = 811;
    public static final int chillingWater = 812;
    public static final int hyperDrill = 813;
    public static final int twinBeam = 814;
    public static final int rageFist = 815;
    public static final int armorCannon = 816;
    public static final int bitterBlade = 817;
    public static final int doubleShock = 818;
    public static final int gigatonHammer = 819;
    public static final int comeuppance = 820;
    public static final int aquaCutter = 821;
    public static final int blazingTorque = 822;
    public static final int wickedTorque = 823;
    public static final int noxiousTorque = 824;
    public static final int combatTorque = 825;
    public static final int magicalTorque = 826;
    public static final int psyblade = 827;
    public static final int hydroSteam = 828;
    public static final int bloodMoon = 829;
    public static final int matchaGotcha = 830;
    public static final int syrupBomb = 831;
    public static final int ivyCudgel = 832;
    public static final int electroShot = 833;
    public static final int teraStarstorm = 834;
    public static final int fickleBeam = 835;
    public static final int burningBulwark = 836;
    public static final int thunderclap = 837;
    public static final int mightyCleave = 838;
    public static final int tachyonCutter = 839;
    public static final int hardPress = 840;
    public static final int dragonCheer = 841;
    public static final int alluringVoice = 842;
    public static final int temperFlare = 843;
    public static final int supercellSlam = 844;
    public static final int psychicNoise = 845;
    public static final int upperHand = 846;
    public static final int malignantChain = 847;
}