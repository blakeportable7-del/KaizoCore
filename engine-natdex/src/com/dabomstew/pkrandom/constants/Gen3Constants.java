...
public class Gen3Constants {
    ...
    public static final int efrlgPokemonNamesPointer = 0x144, efrlgMoveNamesPointer = 0x148,
            ...
            efrlgPokemonShinyPalettesPointer = 0x134;
    ...
    private static Map<Integer,String> setupFormeSuffixes() {
        ...
        formeSuffixes.put(Species.skarmoryMega, "-M");
        ...
        formeSuffixes.put(Species.chimechoMega, "-M");
        formeSuffixes.put(Species.absolMega, "-M");
        formeSuffixes.put(Species.absolMegaZ, "-Z");
        ...
        formeSuffixes.put(Species.staraptorMega, "-M");
        formeSuffixes.put(Species.lopunnyMega, "-M");
        formeSuffixes.put(Species.garchompMega, "-M");
        formeSuffixes.put(Species.garchompMegaZ, "-Z");
        formeSuffixes.put(Species.lucarioMega, "-M");
        formeSuffixes.put(Species.lucarioMegaZ, "-Z");
        formeSuffixes.put(Species.abomasnowMega, "-M");
        formeSuffixes.put(Species.galladeMega, "-M");
        formeSuffixes.put(Species.froslassMega, "-M");
        formeSuffixes.put(Species.heatranMega, "-M");
        formeSuffixes.put(Species.darkraiMega, "-M");
        formeSuffixes.put(Species.emboarMega, "-M");
        formeSuffixes.put(Species.excadrillMega, "-M");
        formeSuffixes.put(Species.audinoMega, "-M");
        formeSuffixes.put(Species.scolipedeMega, "-M");
        formeSuffixes.put(Species.scraftyMega, "-M");
        formeSuffixes.put(Species.eelektrossMega, "-M");
        formeSuffixes.put(Species.chandelureMega, "-M");
        formeSuffixes.put(Species.golurkMega, "-M");
        formeSuffixes.put(Species.chesnaughtMega, "-M");
        formeSuffixes.put(Species.delphoxMega, "-M");
        formeSuffixes.put(Species.greninjaMega, "-M");
        formeSuffixes.put(Species.pyroarMega, "-M");
        formeSuffixes.put(Species.floetteMega, "-M");
        formeSuffixes.put(Species.meowsticMega, "-M");
        formeSuffixes.put(Species.meowsticFMega, "-FM");
        formeSuffixes.put(Species.malamarMega, "-M");
        formeSuffixes.put(Species.barbaracleMega, "-M");
        formeSuffixes.put(Species.dragalgeMega, "-M");
        formeSuffixes.put(Species.hawluchaMega, "-M");
        formeSuffixes.put(Species.zygardeMega, "-M");
        formeSuffixes.put(Species.diancieMega, "-M");
        formeSuffixes.put(Species.crabominableMega, "-M");
        formeSuffixes.put(Species.golisopodMega, "-M");
        formeSuffixes.put(Species.drampaMega, "-M");
        formeSuffixes.put(Species.magearnaMega, "-M");
        formeSuffixes.put(Species.zeraoraMega, "-M");
        formeSuffixes.put(Species.falinksMega, "-M");
        formeSuffixes.put(Species.scovillainMega, "-M");
        formeSuffixes.put(Species.glimmoraMega, "-M");
        formeSuffixes.put(Species.tatsugiriMega, "-M");
        formeSuffixes.put(Species.baxcaliburMega, "-M");
