...
public class FileFunctions {
    ...
    public static boolean configExists(String filename) {
        ...
        return FileFunctions.class.getResource("/com/dabomstew/pkrandomzx/config/" + filename) != null;
    }
    ...
    public static InputStream openConfig(String filename) throws FileNotFoundException {
        ...
        return FileFunctions.class.getResourceAsStream("/com/dabomstew/pkrandomzx/config/" + filename);
    }
    ...
    private static byte[] getCodeTweakFile(String filename) throws IOException {
        InputStream is = FileFunctions.class.getResourceAsStream("/com/dabomstew/pkrandomzx/patches/" + filename);
