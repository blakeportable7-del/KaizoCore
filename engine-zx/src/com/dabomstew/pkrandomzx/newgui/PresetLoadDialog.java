...
import com.dabomstew.pkrandomzx.romhandlers.Abstract3DSRomHandler;
...
public class PresetLoadDialog extends JDialog {
    ...
    public PresetLoadDialog(NewRandomizerGUI parent, JFrame frame) {
        super(frame, true);
        bundle = java.util.ResourceBundle.getBundle("com/dabomstew/pkrandomzx/newgui/Bundle"); // NOI18N
        initComponents();
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("com/dabomstew/pkrandomzx/newgui/Bundle"); // NOI18N
