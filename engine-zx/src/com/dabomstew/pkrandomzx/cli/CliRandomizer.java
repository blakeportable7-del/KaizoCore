package com.dabomstew.pkrandomzx.cli;
...
public class CliRandomizer {
    ...
    private final static ResourceBundle bundle = java.util.ResourceBundle.getBundle("com/dabomstew/pkrandomzx/newgui/Bundle");
    ...
    private static boolean performDirectRandomization(String settingsFilePath, String sourceRomFilePath,
        ...
        try {
            ...
            // taken from com.dabomstew.pkrandomzx.newgui.NewRandomizerGUI.saveROM, set distinctly from all other settings
